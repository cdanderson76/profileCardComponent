...
This is an HTML/CSS project that was made available by Frontend Mentor. It challenges you to use its provided files and compose CSS in order to build out a profile card for the listed individual.
...
I'm most proud that the design turned out the way that it did. I was able to get the 'svg' files to work accordingly and created the resulting background.  I didn't have a lot of experience using the 'background-position' property to produce 
UIs such as these, but it was nice to gain some familiarity using this property.
